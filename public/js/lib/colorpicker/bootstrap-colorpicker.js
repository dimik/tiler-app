...
(function(factory) {
        ...
        if (typeof define === 'function' && define.amd) {
            ...
            modules.define('bootstrap-colorpicker', ['jquery'], function (provide, jQuery) {
                factory(jQuery);
                provide();
            });
    ...
    (function($) {
            ...
            toString: function(format) {
                ...
                switch (format) {
                    ...
                    case 'rgba':
                        {
                            var rgb = this.toRGB();
                            return 'rgba(' + rgb.r + ',' + rgb.g + ',' + rgb.b + ',' + rgb.a.toPrecision(2) + ')';
                        }
                        break;
                    case 'hsl':
                        {
        ...
        var Colorpicker = function(element, options) {
            ...
            if(isFinite(this.options.alpha)) {
                this.color.setAlpha(this.options.alpha);
            }
